...
//   const SERVICE_ID = "service_qwerty21";
//   const TEMPLATE_ID = "template_xrazsrk";
//   const PUBLIC_KEY = "WTgZlEhlvwe0uNR8A";
...
//             <button
//               type="submit"
//               className="w-full bg-blue-500 text-white py-3 px-6 rounded font-medium transition-transform  duration-150 ease-in-out relative overflow-hidden hover:-translate-y-0.5 hover:scale-95 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"
//             >
//               Send Message
//             </button>
//           </form>
