...
const ProjectCard = ({ project }) => {
   return (
      ...
      <motion.div
         ...
         whileInView={{ opacity: 1, y: 0 }}
         transition={{ duration: 0.5 }}
         className="bg-white/5 rounded-xl overflow-hidden border border-white/10 group hover:-translate-y-2 transition-all duration-300 flex flex-col"
      >
         <div className="overflow-hidden">
            <motion.img
               whileHover={{ scale: 1.05 }}
         ...
         <div className="p-6 flex flex-col flex-1">
            <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent min-h-[3.5rem] flex items-center">
               {project.title}
            </h3>
